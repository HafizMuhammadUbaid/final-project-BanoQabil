...
# ---------------- API HELPER FUNCTIONS (Open-Meteo) ----------------
@st.cache_data(ttl=1800)
def geocode_city(city_name):
    """Fetches latitude and longitude for any city without requiring an API key."""
...
def fetch_weather_data(lat, lon):
    """Fetches real-time, hourly, and daily forecast metrics."""
    url = (
...
def decode_wmo_code(code):
    """Converts WMO Weather Codes to Human Readable Descriptions & Icons."""
    mapping = {
        0: ("Clear Sky", "☀️"),
        1: ("Mainly Clear", "🌤️"),
        2: ("Partly Cloudy", "⛅"),
